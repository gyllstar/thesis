...
new_file_base="thesis-proposal-v2"
...
# update the base file name
cmd = 'mv %s.pdf %s.pdf' %(file_base,new_file_base)
print " Step (1.5a) executing '%s'" %(cmd)
os.system(cmd)

cmd = 'cp %s.bib %s.bib' %(file_base,new_file_base)
print " Step (1.5b) executing '%s'" %(cmd)
os.system(cmd)
...
# base files
cmd = 'cp *.tex %s.bib %s.pdf %s' %(new_file_base,new_file_base,private_location)
...
cmd = 'cp %s.pdf %s' %(new_file_base,public_location)
