...
\begin{figure*}[t]
\centering
\subfigure[{$p=0.05$, diameter=$6.14$}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg5.pdf}}
\subfigure[{$p=0.15$, diameter=$3.01$}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg15.pdf}}
\subfigure[{$p=0.25$, diameter=$2.99$}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg25.pdf}}
\subfigure[{$p=0.50$, diameter=$2$}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg50.pdf}}
...
Because the trends for time overhead match trends for message overhead, we only show the time overhead for $p=.05$ (Figure \ref{fig:epoch}). 
...
\begin{figure*}[t]
\centering
\subfigure[{$p=0.05$, diameter=$6.14$}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg-rand5.pdf}}
\subfigure[{$p=0.15$, diameter=$3.01$}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg-rand15.pdf}}
\subfigure[{$p=0.25$, diameter=$2.99$}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg-rand25.pdf}}
\subfigure[{$p=0.50$, diameter=$2$}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg-rand50.pdf}}
...
\begin{figure*}[t]
\centering
\subfigure[{GT-ITM, diameter=$ $}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg-att.pdf}}
\subfigure[{Rocketfuel 6461, $n=141$, average node degree=$2.62$, diameter=$8$}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg6461.pdf}}
\subfigure[{Rocketfuel 3867, diameter=$ $}]{\includegraphics[width=0.32\textwidth]{figs/synch/msg3867.pdf}}
...
\begin{figure*}[h]
\centering
\subfigure[{GT-ITM}]{\includegraphics[width=0.32\textwidth]{figs/synch/att-epoch.pdf}}
...
\subfigure[{Rocketfuel 3867}]{\includegraphics[width=0.32\textwidth]{figs/synch/rocket-epoch3867.pdf}}
%\subfigure[{Cumulative path cost decreases during the simulation}]{\includegraphics[width=0.49\textwidth]{figs/tsdecrease6.pdf}}
...
\begin{figure*}[t]
\centering
\subfigure[{$p=0.05$, diameter=$6.14, \lambda=1$}]{\includegraphics[width=0.32\textwidth]{figs/synch/p05-lc1.pdf}}
\subfigure[{$p=0.05$, diameter=$6.14, \lambda=2$}]{\includegraphics[width=0.32\textwidth]{figs/synch/p05-lc2.pdf}}
\subfigure[{$p=0.05$, diameter=$6.14,\lambda=4$}]{\includegraphics[width=0.32\textwidth]{figs/synch/p05-lc4.pdf}}
\subfigure[{$p=0.05$, diameter=$6.14, \lambda=8$}]{\includegraphics[width=0.32\textwidth]{figs/synch/p05-lc8.pdf}}
%\subfigure[{Cumulative path cost decreases during the simulation}]{\includegraphics[width=0.49\textwidth]{figs/tsdecrease6.pdf}}
