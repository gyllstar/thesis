...
%Also they prove that in the worst case, {\tt greedy} from Section \ref{sec:approx} does no better $\Theta(n)$ of the optimal solution.  
%However, this approximation ratio assumes that all nodes are zero-injection.
