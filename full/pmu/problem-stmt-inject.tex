...
In effort to keep this proposal document relatively short, we omit the actual NP-Completeness proofs and instead present proof sketches; details can be found in \cite{Gyllstrom12}.
...
\begin{figure}
  \begin{center}
    \subfigure[Modified variable gadget used in \full and \maxincs, containing additional injection nodes: $I_{i1}, I_{i2}, \dots I_{ip}$. ]{\label{fig:variable-inject-extend}\includegraphics[scale=0.61]{figs/extensions/vgadget-inject-extend.pdf}}
	...
	and nodes $I_{i1}^b, I_{i2}^b, \dots I_{ip}^b$ are included in the bottom subgraph.]
	 {\label{fig:variable-inject-extend2}\includegraphics[scale=0.61]{figs/extensions/vgadget-inject-extend2.pdf}}
  \end{center}
...
\begin{figure}
  \begin{center}
    \subfigure[Modified variable gadget used in \full and \maxincs, containing additional injection nodes: $Z_{i1}, Z_{i2}, \dots Z_{ip}$. ]{\label{fig:variable-noninject-extend}\includegraphics[scale=0.61]{figs/extensions/vgadget-noninject-extend.pdf}}
    \subfigure[Modified variable gadget used in \xval and \xvalparts. Each disconnected subgraph has additional injection nodes: the upper subgraph includes nodes $Z_{i1}^t, Z_{i2}^t, \dots Z_{ip}^t$
	 ...
	 {\label{fig:variable-noninject-extend2}\includegraphics[scale=0.61]{figs/extensions/vgadget-noninject-extend2.pdf}}
  \end{center}
