...
%Their OpenFlow implementation provided significantadvantages as compared to non-SDN based algorithms with similar goals. 
...
First, we presented \pcnts, an algorithm that uses OpenFlow primitives to accurately detect per-link packet loss inside the network rather than using slower E2E measurements. % at small time scales.
