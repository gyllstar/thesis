...
\begin{figure*}[t]
  \begin{center}
    \subfigure[Original multicast trees $T_b$ (green) and $T_c$ (blue). ]{\label{fig:intuition-example-t1}\includegraphics[scale=0.52]{figs/multi-tree-example1.pdf}} 
    \subfigure[Backup multicast trees -- $\hat{T}_b$ and $\hat{T}_c$ for $T_b$ and $T_c$, respectively --  installed after $(g,l)$ fails. Links unique to each backup tree are circled.]
		{\label{fig:intuition-example-t2}\includegraphics[scale=0.52]{figs/multi-tree-example2.pdf}} 
  \end{center}
