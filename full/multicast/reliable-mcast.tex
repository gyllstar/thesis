...
\begin{enumerate}
	...
	\footnote{\xxn{Unforuntately, OpenFlow does not allow a flow's priority to be modified.  As a workaround, we install a copy of $e$ and $e'$, which we refer to as $e_c$ and $e'_c$, respectively.
	We ensure that $e_c$ has a higher priority than $e'_c$.  Finally, we delete flows $e$ and $e'$. }}
