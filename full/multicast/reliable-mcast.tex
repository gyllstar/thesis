...
\begin{enumerate}
	...
	\footnote{\xxn{Unfortunately, OpenFlow does not allow a flow's priority to be modified.  As a workaround, we install a copy of $e$ and $e'$, which we refer to as $e_c$ and $e'_c$, respectively.
