...
\begin{figure*}[t]
  \begin{center}
	...
	\subfigure[Total time to install all backup tree flow entries.]{\label{fig:install-time57}\includegraphics[scale=0.4]{figs/install-time-ieee57.pdf}}
	...
	\subfigure[\posts: number of stale flow entries resulting from link failure. ]{\label{fig:reactive-garbage57}\includegraphics[scale=0.4]{figs/garbage-ieee57.pdf}}
    \subfigure[\pres: number of stale flow entries resulting from link failure. ]{\label{fig:preinstall-garbage57}\includegraphics[scale=0.4]{figs/preinstall-garbage-ieee57.pdf}}
  \end{center} 
